<p align="center">
  <img src="./public/ReTune.png" alt="ReTune icon" width="350" />
</p>

<h1 align="center">ReTune</h1>

ReTune injects pitch control into YouTube, enabling real-time audio pitch adjustment without altering playback speed.

To use the extension, you can either download the folder or clone it using the command. 

```ps1
git clone https://github.com/Quema100/TubePeek.git
```
